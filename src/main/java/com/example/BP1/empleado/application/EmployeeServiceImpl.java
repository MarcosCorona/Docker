package com.example.BP1.empleado.application;
...
import com.example.BP1.empleado.domain.EmployeeRowMapper;
...
public class EmployeeServiceImpl implements EmployeeService {
    public EmployeeServiceImpl(NamedParameterJdbcTemplate template) {
    ...
    public void insertEmployee(Employee emp) {
        final String sql = "insert into employee( employeeName, employeeEmail, employeeAddress ) values(:employeeName,:employeeEmail,:employeeAddress)";
